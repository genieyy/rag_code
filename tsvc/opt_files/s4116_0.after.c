...
//    gather is required
    ...
    int off;
#pragma scop
/* Optimized Code 1: Unroll the Inner Loop
Unrolling the inner loop can reduce the overhead of loop control and improve performance by allowing the compiler to generate more efficient code.
