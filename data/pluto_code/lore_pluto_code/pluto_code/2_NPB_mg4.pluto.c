  ...
  for (t1=lbp;t1<=ubp;t1++) {
    for (t2=0;t2<=floord(ITERATIONS-1,32);t2++) {
      if ((d1 <= mm1-1) && (d2 <= mm2-1)) {
        for (t3=max(d3,32*t1);t3<=min(mm3-1,32*t1+31);t3++) {
...
#pragma vector always
              for (t9=lbv;t9<=ubv;t9++) {
                u[2 * t3 - d3 - 1][2 * t6 - d2 - 1][2 * t9 - d1 - 1] = u[2 * t3 - d3 - 1][2 * t6 - d2 - 1][2 * t9 - d1 - 1] + z[t3 - 1][t6 - 1][t9 - 1];;
              }
              lbv=1;
              ubv=mm1-1;
#pragma ivdep
#pragma vector always
              for (t9=lbv;t9<=ubv;t9++) {
                u[2 * t3 - d3 - 1][2 * t6 - d2 - 1][2 * t9 - c1 - 1] = u[2 * t3 - d3 - 1][2 * t6 - d2 - 1][2 * t9 - c1 - 1] + 0.5 * (z[t3 - 1][t6 - 1][t9] + z[t3 - 1][t6 - 1][t9 - 1]);;
              }
            }
...
#pragma vector always
              for (t9=lbv;t9<=ubv;t9++) {
                u[2 * t3 - d3 - 1][2 * t6 - c2 - 1][2 * t9 - d1 - 1] = u[2 * t3 - d3 - 1][2 * t6 - c2 - 1][2 * t9 - d1 - 1] + 0.5 * (z[t3 - 1][t6][t9 - 1] + z[t3 - 1][t6 - 1][t9 - 1]);;
              }
              lbv=1;
              ubv=mm1-1;
#pragma ivdep
#pragma vector always
              for (t9=lbv;t9<=ubv;t9++) {
                u[2 * t3 - d3 - 1][2 * t6 - c2 - 1][2 * t9 - c1 - 1] = u[2 * t3 - d3 - 1][2 * t6 - c2 - 1][2 * t9 - c1 - 1] + 0.25 * (z[t3 - 1][t6][t9] + z[t3 - 1][t6 - 1][t9] + z[t3 - 1][t6][t9 - 1] + z[t3 - 1][t6 - 1][t9 - 1]);;
              }
            }
          }
        }
